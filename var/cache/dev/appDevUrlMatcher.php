...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'UserBundle\\Controller\\UserController::indexAction',  '_route' => 'homepage',);
        }

        // contact_list
        if ($pathinfo === '/contact-list') {
            return array (  '_controller' => 'UserBundle\\Controller\\ContactController::showAction',  '_route' => 'contact_list',);
        }

        // new_contact
        if ($pathinfo === '/new-contact') {
